//                     Finalised code of Car rental system used OOP C++ to write it consists of different functions each fucntion has its own importance 
//                     such as the ones with print function in it they are used to display different scenarios. 
//                     This code is submitted by:
//                     Muhammad Dawood Bilal (2022365 Section F)    M Ashir (2022353 Section F)  Taha Nabeegh (2022589 Sec-f)  & Hassan Ahmed (2022208 Sec-f)
//                     Regards.
...
public:
    ...
    Car(string name, string model, string year, int rentCost) {
        this->name = name;
        this->model = model;
        this->year = year;
